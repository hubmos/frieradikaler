...
const Header =({acts}) => {
    ...
    return (
    <div class='hero min-h-screen bg-cover bg-[linear-gradient(180deg,rgba(236,227,202,0.5),rgba(236,227,202,1)_95%),url("/images/springs.jpg")] flex flex-col justify-between'>
    <div class="flex-grow flex items-center">
        <div class="hero-content text-center flex-grow">
            <div class="max-w-md mx-auto">
                ...
                <h2 class="py-6">Veien går mot sør, langs <a href="#mordor" class="btn btn-primary btn-sm">Misty Mountains</a> !</h2>
            </div>
        </div>
    </div>
